...
class _PressureState extends State<Pressure> {
  ...
  List<String> item = ['па','бар','мм.рт.ст.'];
  ...
  void editingComplete(String droptext1, String droptext2) {
    if(input.text.isEmpty){}
      ...
      if (droptext1 == 'па' && droptext2 == 'бар')
      {
        out.text = (double.parse(input.text) / 100000).toString();
      }
      else if (droptext1 == 'па' && droptext2 == 'мм.рт.ст.')
      {
        out.text = (double.parse(input.text) * 0.0075).toString();
      }
      else if (droptext1 == 'бар' && droptext2 == 'па')
      {
        out.text = (double.parse(input.text) * 100000).toString();
      }
      else if (droptext1 == 'бар' && droptext2 == 'мм.рт.ст.')
      {
        out.text = (double.parse(input.text) * 750.06).toString();
      }
      else if (droptext1 == 'мм.рт.ст.' && droptext2 == 'бар')
      {
        out.text = (double.parse(input.text) * 0.0013).toString();
      }
      else if (droptext1 == 'мм.рт.ст.' && droptext2 == 'па')
      {
        out.text = (double.parse(input.text) * 133.32).toString();
      }
    }
  }
